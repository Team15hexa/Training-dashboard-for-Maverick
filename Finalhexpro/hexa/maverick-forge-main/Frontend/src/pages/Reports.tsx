            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Button
                  ...
                  onClick={() => toast({ title: "Monthly Report", description: "Generating monthly report...", duration: 3000 })}
                >
                ...
                <Button
                  variant="outline"
                  className="flex items-center gap-2 h-auto p-4"
                  onClick={() => toast({ title: "Performance Report", description: "Generating performance report...", duration: 3000 })}
                >
                ...
                <Button
                  variant="outline"
                  className="flex items-center gap-2 h-auto p-4"
                  onClick={() => toast({ title: "User Report", description: "Generating user report...", duration: 3000 })}
                >
