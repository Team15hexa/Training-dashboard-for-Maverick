...
-- Track daily login activity per fresher
CREATE TABLE login_activity (
  id INT AUTO_INCREMENT PRIMARY KEY,
  fresher_id INT NOT NULL,
  login_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  INDEX idx_login_activity_fresher_date (fresher_id, login_at),
...
('Software Engineering', 'Development and programming roles'),
...
INSERT INTO freshers (name, email, password, department, role, gpa, college, join_date, skills, experience, quizzes, coding, assignments, certifications) VALUES
('John Doe', 'john.doe@company.com', 'john123', 'Software Engineering', 'fresher', 3.8, 'MIT', CURRENT_DATE, 'JavaScript, React, Node.js', '0 years', '85', '92', '88', '90'),
('Jane Smith', 'jane.smith@company.com', 'jane123', 'Data Science', 'fresher', 3.9, 'Stanford', CURRENT_DATE, 'Python, Machine Learning, SQL', '1 year', '92', '88', '95', '87'),
('Mike Johnson', 'mike.johnson@company.com', 'mike123', 'DevOps', 'fresher', 3.7, 'UC Berkeley', CURRENT_DATE, 'Docker, Kubernetes, AWS', '0 years', '92', '88', '85', '70'),
('Sarah Wilson', 'sarah.wilson@company.com', 'sarah123', 'Marketing', 'fresher', 3.6, 'UCLA', CURRENT_DATE, 'Digital Marketing, Analytics', '2 years', '88', '75', '90', '85'),
('David Brown', 'david.brown@company.com', 'david123', 'Sales', 'fresher', 3.5, 'USC', CURRENT_DATE, 'Sales Techniques, CRM', '1 year', '82', '70', '85', '88'),
('Alice Johnson', 'alice.johnson@company.com', 'ali123', 'Data Science', 'fresher', 3.8, 'Harvard', CURRENT_DATE, 'Python, Data Analysis, Visualization', '0 years', '90', '85', '92', '88'),
('Nimisha Ramesh', 'nimisharamesh21@gmail.com', 'nimi123', 'Software Engineering', 'fresher', 3.9, 'IIT', CURRENT_DATE, 'Java, Spring Boot, Microservices', '0 years', '95', '88', '92', '85');
