      ...
      try {
        ...
        if (response.ok) {
          ...
          const fresherData = {
            ...
            department: data.department || currentUser.department || "Unknown Domain",
            skills: data.skills || [],
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        {/* Complete Course Schedule Section */}
        <section>
          <h2 className="text-2xl font-bold mb-6 dashboard-heading bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Complete Course Schedule</h2>
          <div className="grid lg:grid-cols-1 gap-6">
            <Card className={`border-0 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl ${
              darkMode ? 'bg-gray-800 border-gray-700 hover:bg-gray-700' : 'bg-gradient-to-br from-orange-50 to-red-100 border border-orange-200 hover:from-orange-100 hover:to-red-200'
            }`}>
              <CardHeader>
                <CardTitle className={`flex items-center gap-2 transition-all duration-300 hover:scale-105 ${darkMode ? 'text-white' : 'text-orange-800'} dashboard-card-title`}>
                  <Calendar className={`w-5 h-5 transition-transform duration-300 hover:rotate-12 ${darkMode ? 'text-orange-400' : 'text-orange-600'}`} />
                  {fresher?.department || 'Software Engineering'} - Complete Training Schedule
                </CardTitle>
                <CardDescription className={`transition-colors duration-300 hover:text-orange-600 ${darkMode ? 'text-gray-300' : 'text-orange-700'}`}>
                  Day-by-day training program tailored to your department
                </CardDescription>
              </CardHeader>
              <CardContent>
                {(() => {
                  // Course schedules based on department with different timelines
                  const courseSchedules = {
                    "Software Engineering": [
                      { day: 1, topic: "Programming Fundamentals", duration: "3 hours", description: "Variables, data types, control structures, and basic algorithms" },
                      { day: 2, topic: "Object-Oriented Programming", duration: "4 hours", description: "Classes, objects, inheritance, polymorphism, and encapsulation" },
                      { day: 3, topic: "Data Structures & Algorithms", duration: "4 hours", description: "Arrays, linked lists, stacks, queues, and basic algorithms" },
                      { day: 4, topic: "Database Design & SQL", duration: "3 hours", description: "ERD, normalization, SQL queries, and database relationships" },
                      { day: 5, topic: "Web Development Basics", duration: "3 hours", description: "HTML5, CSS3, responsive design, and JavaScript fundamentals" },
                      { day: 6, topic: "Frontend Framework (React)", duration: "4 hours", description: "Components, props, state, hooks, and component lifecycle" },
                      { day: 7, topic: "Backend Development (Node.js)", duration: "4 hours", description: "Express.js, REST APIs, middleware, and server-side logic" },
                      { day: 8, topic: "Database Integration", duration: "3 hours", description: "MongoDB, Mongoose, data modeling, and CRUD operations" },
                      { day: 9, topic: "Authentication & Security", duration: "3 hours", description: "JWT tokens, password hashing, CORS, and security best practices" },
                      { day: 10, topic: "Testing & Debugging", duration: "3 hours", description: "Unit testing, integration testing, Jest, and debugging techniques" },
                      { day: 11, topic: "Version Control & Git", duration: "2 hours", description: "Git workflow, branching, merging, and collaboration" },
                      { day: 12, topic: "Deployment & DevOps", duration: "3 hours", description: "Heroku, Vercel, environment variables, and CI/CD basics" },
                      { day: 13, topic: "Performance Optimization", duration: "3 hours", description: "Code optimization, caching, lazy loading, and performance monitoring" },
                      { day: 14, topic: "Advanced Concepts", duration: "4 hours", description: "Microservices, Docker basics, API design patterns, and scalability" },
                      { day: 15, topic: "Final Project", duration: "6 hours", description: "Complete full-stack application development and deployment" }
                    ],
                    "Data Science": [
                      { day: 1, topic: "Python Programming for DS", duration: "4 hours", description: "Python basics, NumPy arrays, and mathematical operations" },
                      { day: 2, topic: "Data Manipulation with Pandas", duration: "4 hours", description: "DataFrames, data cleaning, filtering, and transformation techniques" },
                      { day: 3, topic: "Data Visualization", duration: "3 hours", description: "Matplotlib, Seaborn, Plotly, and creating insightful visualizations" },
                      { day: 4, topic: "Statistical Analysis", duration: "4 hours", description: "Descriptive statistics, probability distributions, and hypothesis testing" },
                      { day: 5, topic: "SQL for Data Analysis", duration: "3 hours", description: "Complex queries, joins, aggregations, and data extraction" },
                      { day: 6, topic: "Exploratory Data Analysis", duration: "4 hours", description: "Data exploration, correlation analysis, and feature understanding" },
                      { day: 7, topic: "Machine Learning Fundamentals", duration: "4 hours", description: "Supervised vs unsupervised learning, model types, and evaluation metrics" },
                      { day: 8, topic: "Linear Regression & Classification", duration: "4 hours", description: "Linear regression, logistic regression, and model evaluation" },
                      { day: 9, topic: "Advanced ML Algorithms", duration: "4 hours", description: "Random forests, SVM, decision trees, and ensemble methods" },
                      { day: 10, topic: "Feature Engineering", duration: "3 hours", description: "Feature selection, scaling, encoding, and dimensionality reduction" },
                      { day: 11, topic: "Deep Learning Basics", duration: "4 hours", description: "Neural networks, TensorFlow/Keras, and basic architectures" },
                      { day: 12, topic: "Natural Language Processing", duration: "3 hours", description: "Text preprocessing, sentiment analysis, and NLP libraries" },
                      { day: 13, topic: "Big Data & Cloud Computing", duration: "3 hours", description: "Hadoop, Spark basics, and cloud platforms (AWS/GCP)" },
                      { day: 14, topic: "Model Deployment & MLOps", duration: "3 hours", description: "Model serving, APIs, monitoring, and production deployment" },
                      { day: 15, topic: "Data Science Project", duration: "6 hours", description: "End-to-end data science project with real-world dataset" }
                    ],
                    "DevOps": [
                      { day: 1, topic: "Linux & Shell Scripting", duration: "4 hours", description: "Linux commands, bash scripting, and system administration basics" },
                      { day: 2, topic: "Version Control with Git", duration: "3 hours", description: "Git workflow, branching strategies, and collaboration practices" },
                      { day: 3, topic: "Containerization with Docker", duration: "4 hours", description: "Docker basics, images, containers, Dockerfile, and Docker Compose" },
                      { day: 4, topic: "Container Orchestration", duration: "4 hours", description: "Kubernetes architecture, pods, services, and deployments" },
                      { day: 5, topic: "Advanced Kubernetes", duration: "4 hours", description: "ConfigMaps, Secrets, persistent volumes, and scaling" },
                      { day: 6, topic: "CI/CD Pipeline Design", duration: "4 hours", description: "Jenkins, GitHub Actions, pipeline stages, and automation" },
                      { day: 7, topic: "Infrastructure as Code", duration: "4 hours", description: "Terraform, Ansible, and infrastructure automation" },
                      { day: 8, topic: "Cloud Platforms (AWS)", duration: "4 hours", description: "EC2, S3, VPC, IAM, and AWS services integration" },
                      { day: 9, topic: "Monitoring & Observability", duration: "3 hours", description: "Prometheus, Grafana, logging, and alerting systems" },
                      { day: 10, topic: "Security in DevOps", duration: "3 hours", description: "Security scanning, secrets management, and compliance" },
                      { day: 11, topic: "Microservices Architecture", duration: "4 hours", description: "Service design, communication patterns, and API gateways" },
                      { day: 12, topic: "Performance & Scalability", duration: "3 hours", description: "Load balancing, auto-scaling, and performance optimization" },
                      { day: 13, topic: "Disaster Recovery", duration: "3 hours", description: "Backup strategies, recovery procedures, and business continuity" },
                      { day: 14, topic: "DevOps Tools Integration", duration: "4 hours", description: "Integrating various tools and creating comprehensive pipelines" },
                      { day: 15, topic: "DevOps Project", duration: "6 hours", description: "Complete DevOps pipeline implementation and deployment" }
                    ],
                    "Quality Assurance": [
                      { day: 1, topic: "Software Testing Fundamentals", duration: "3 hours", description: "Testing types, methodologies, and testing lifecycle" },
                      { day: 2, topic: "Manual Testing Techniques", duration: "4 hours", description: "Test case design, execution, defect reporting, and test documentation" },
                      { day: 3, topic: "Test Automation Basics", duration: "3 hours", description: "Automation frameworks, Selenium WebDriver, and test automation strategy" },
                      { day: 4, topic: "Selenium with Java/Python", duration: "4 hours", description: "Web element interaction, waits, assertions, and test organization" },
                      { day: 5, topic: "Test Framework Design", duration: "3 hours", description: "TestNG/JUnit, test annotations, and reporting mechanisms" },
                      { day: 6, topic: "API Testing", duration: "4 hours", description: "REST API testing, Postman, automation, and API validation" },
                      { day: 7, topic: "Performance Testing", duration: "3 hours", description: "JMeter, load testing, stress testing, and performance metrics" },
                      { day: 8, topic: "Mobile Testing", duration: "3 hours", description: "Mobile app testing, Appium, and mobile automation strategies" },
                      { day: 9, topic: "Database Testing", duration: "3 hours", description: "SQL testing, data validation, and database automation" },
                      { day: 10, topic: "Security Testing", duration: "3 hours", description: "Security vulnerabilities, penetration testing, and security tools" },
                      { day: 11, topic: "Test Management", duration: "3 hours", description: "JIRA, TestRail, test case management, and reporting" },
                      { day: 12, topic: "Continuous Testing", duration: "4 hours", description: "CI/CD integration, automated testing pipelines, and continuous testing" },
                      { day: 13, topic: "Behavior Driven Development", duration: "3 hours", description: "Cucumber, Gherkin syntax, and BDD practices" },
                      { day: 14, topic: "Advanced Test Automation", duration: "4 hours", description: "Page Object Model, data-driven testing, and framework design" },
                      { day: 15, topic: "QA Project", duration: "6 hours", description: "End-to-end testing project with comprehensive test coverage" }
                    ],
                    "Business Analyst": [
                      { day: 1, topic: "Business Analysis Fundamentals", duration: "3 hours", description: "Role of BA, stakeholders, business processes, and BA framework" },
                      { day: 2, topic: "Requirements Engineering", duration: "4 hours", description: "Requirements gathering techniques, interviews, workshops, and documentation" },
                      { day: 3, topic: "Business Process Modeling", duration: "3 hours", description: "BPMN, process flows, workflow diagrams, and process optimization" },
                      { day: 4, topic: "User Stories & Use Cases", duration: "4 hours", description: "Writing user stories, acceptance criteria, use cases, and requirements traceability" },
                      { day: 5, topic: "Data Analysis & Modeling", duration: "3 hours", description: "Data requirements, ERD, data flow diagrams, and data modeling techniques" },
                      { day: 6, topic: "SQL for Business Analysis", duration: "3 hours", description: "SQL queries, data extraction, reporting, and business intelligence" },
                      { day: 7, topic: "Business Intelligence Tools", duration: "4 hours", description: "Tableau, Power BI, data visualization, and dashboard creation" },
                      { day: 8, topic: "Agile Methodologies", duration: "3 hours", description: "Scrum, Kanban, agile practices for BAs, and sprint planning" },
                      { day: 9, topic: "Stakeholder Management", duration: "3 hours", description: "Communication, negotiation, conflict resolution, and stakeholder analysis" },
                      { day: 10, topic: "Requirements Documentation", duration: "4 hours", description: "BRD, FRD, technical specifications, and documentation standards" },
                      { day: 11, topic: "Change Management", duration: "3 hours", description: "Change impact analysis, training, adoption strategies, and change control" },
                      { day: 12, topic: "Risk Management", duration: "3 hours", description: "Risk identification, assessment, mitigation strategies, and risk monitoring" },
                      { day: 13, topic: "Project Management for BAs", duration: "3 hours", description: "Project planning, scheduling, monitoring, and BA project management" },
                      { day: 14, topic: "Business Analysis Tools", duration: "3 hours", description: "JIRA, Confluence, BA-specific tools, and collaboration platforms" },
                      { day: 15, topic: "BA Project", duration: "6 hours", description: "Complete business analysis project with real-world scenario" }
                    ]
                  };

                  const schedule = courseSchedules[fresher?.department as keyof typeof courseSchedules] || courseSchedules["Software Engineering"];
                    ...
                    <div className="space-y-4">
                      ...
                      <div className={`p-4 rounded-xl transition-all duration-300 ${
                        ...
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-md">
                            <Calendar className="w-5 h-5 text-white transition-transform duration-300 hover:rotate-12" />
                </div>
                          <div>
                            <h4 className={`font-semibold text-lg transition-colors duration-300 ${darkMode ? 'text-white' : 'text-gray-800'}`}>
                              {fresher?.department || 'Software Engineering'} Training Program
                            </h4>
                            <p className={`text-sm transition-colors duration-300 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                              {schedule.length} days • {schedule.reduce((total, day) => total + parseInt(day.duration), 0)} hours total
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid gap-4">
                        {schedule.map((day, index) => (
                          <div 
                            key={day.day}
                            className={`group relative overflow-hidden rounded-xl p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg cursor-pointer ${
                              darkMode 
                                ? 'bg-gradient-to-r from-gray-800 to-gray-900 border border-gray-700 hover:from-gray-700 hover:to-gray-800' 
                                : 'bg-gradient-to-r from-white to-gray-50 border border-gray-200 hover:from-orange-50 hover:to-red-50 hover:border-orange-300'
                            }`}
                          >
                            {/* Day number badge */}
                            <div className="absolute top-4 right-4">
                              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${
                                darkMode 
                                  ? 'bg-gradient-to-br from-orange-500 to-red-500 text-white group-hover:scale-110' 
                                  : 'bg-gradient-to-br from-orange-500 to-red-500 text-white group-hover:scale-110'
                              }`}>
                                {day.day}
                              </div>
                            ...
                            <div className="flex items-start gap-4">
                              ...
                              <div className="relative">
                                <div className={`w-3 h-3 rounded-full transition-all duration-300 ${
                                  darkMode 
                                    ? 'bg-gray-600 group-hover:bg-orange-500' 
                                    : 'bg-gray-300 group-hover:bg-orange-500'
                                }`} />
                                {index < schedule.length - 1 && (
                                  <div className={`absolute top-3 left-1.5 w-0.5 h-16 transition-all duration-300 ${
                                    darkMode ? 'bg-gray-600' : 'bg-gray-300'
                                  }`} />
                                )}
              </div>
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                  <h5 className={`text-lg font-semibold transition-colors duration-300 group-hover:text-orange-600 ${darkMode ? 'text-white' : 'text-gray-800'}`}>
                                    {day.topic}
                                  </h5>
                                  <Badge 
                                    variant="secondary" 
                      ...
                      <div className={`p-4 rounded-xl transition-all duration-300 ${
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <h5 className={`font-semibold transition-colors duration-300 ${darkMode ? 'text-white' : 'text-gray-800'}`}>
                              Training Summary
                            </h5>
                            <p className={`text-sm transition-colors duration-300 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                              Complete your {schedule.length}-day training program
                            </p>
                          </div>
                          <div className="text-right">
                            <div className={`text-2xl font-bold transition-colors duration-300 ${darkMode ? 'text-green-400' : 'text-green-600'}`}>
