  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        // Mark today's login for the dashboard calendar to pick up immediately
        const toLocalISO = () => {
          const d = new Date();
        ...
        localStorage.setItem('loginActivityTodayISO', toLocalISO());
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 transition-all duration-300 hover:bg-white/20 hover:border-white/40 hover:scale-105 hover:shadow-xl cursor-pointer group">
                <Brain className="w-8 h-8 text-blue-300 mb-2 transition-all duration-300 group-hover:text-blue-200 group-hover:scale-110" />
                <h3 className="font-semibold text-white mb-1 transition-colors duration-300 group-hover:text-blue-100">AI Resume Parser</h3>
                <p className="text-sm text-white/70 transition-colors duration-300 group-hover:text-white/90">Automatically extract skills from resumes</p>
              </div>
              
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 transition-all duration-300 hover:bg-white/20 hover:border-white/40 hover:scale-105 hover:shadow-xl cursor-pointer group">
                <GraduationCap className="w-8 h-8 text-purple-300 mb-2 transition-all duration-300 group-hover:text-purple-200 group-hover:scale-110" />
                <h3 className="font-semibold text-white mb-1 transition-colors duration-300 group-hover:text-purple-100">Smart Training</h3>
                <p className="text-sm text-white/70 transition-colors duration-300 group-hover:text-white/90">Personalized learning paths</p>
              </div>  
              
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 transition-all duration-300 hover:bg-white/20 hover:border-white/40 hover:scale-105 hover:shadow-xl cursor-pointer group">
                <Shield className="w-8 h-8 text-green-300 mb-2 transition-all duration-300 group-hover:text-green-200 group-hover:scale-110" />
                <h3 className="font-semibold text-white mb-1 transition-colors duration-300 group-hover:text-green-100">Secure Access</h3>
                <p className="text-sm text-white/70 transition-colors duration-300 group-hover:text-white/90">Role-based authentication</p>
              </div>
              
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 transition-all duration-300 hover:bg-white/20 hover:border-white/40 hover:scale-105 hover:shadow-xl cursor-pointer group">
                <User className="w-8 h-8 text-pink-300 mb-2 transition-all duration-300 group-hover:text-pink-200 group-hover:scale-110" />
                <h3 className="font-semibold text-white mb-1 transition-colors duration-300 group-hover:text-pink-100">Real-time Tracking</h3>
                <p className="text-sm text-white/70 transition-colors duration-300 group-hover:text-white/90">Live progress monitoring</p>
              </div>
            </div>
