      ...
      <Card className={`transition-all duration-300 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'}`}>
        <CardHeader>
          <CardTitle className={`${darkMode ? 'text-white' : 'text-gray-900'}`}>
            Domain Certification Bubble Chart
          </CardTitle>
          <CardDescription className={darkMode ? 'text-gray-400' : 'text-gray-600'}>
            Visual representation of certification completion by Domain
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <CardContent>
        <div className={`space-y-6 transition-all duration-500 ease-in-out ${
          ...
          <div className="space-y-2">
                          <h4 className={`font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Domain Details:</h4>
