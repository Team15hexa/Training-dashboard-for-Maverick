  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className={`text-lg font-semibold transition-all duration-300 ${darkMode ? 'text-white' : 'text-gray-900'}`}>AI-Generated Analytics Charts</h3>
        <Button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className={`transition-all duration-300 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'}`}>
          <CardHeader>
            <CardTitle className={`text-lg transition-all duration-300 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Assessment performance by department</CardTitle>
          </CardHeader>
          <CardContent>
            {renderLineChart(
        ...
        <Card className={`transition-all duration-300 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'}`}>
          <CardHeader>
            <CardTitle className={`text-lg transition-all duration-300 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Quiz Participation</CardTitle>
          </CardHeader>
          <CardContent>
            {renderAreaChart(
      ...
      <Card className={`transition-all duration-300 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'}`}>
        <CardHeader>
          <CardTitle className={`flex items-center gap-2 transition-all duration-300 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
            <Brain className="w-5 h-5 text-purple-600" />
            AI Chart Insights
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <h4 className={`font-medium mb-2 transition-all duration-300 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Assessment Performance</h4>
              <ul className={`text-sm space-y-1 transition-all duration-300 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <div>
              <h4 className={`font-medium mb-2 transition-all duration-300 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Quiz Participation</h4>
              <ul className={`text-sm space-y-1 transition-all duration-300 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
